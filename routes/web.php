...
Route::get('/', [AuthCont::class, 'login']);
Route::post('login', [AuthCont::class, 'AuthLogin']);
Route::get('logout', [AuthCont::class, 'logout']);
Route::get('forgot-password', [AuthCont::class, 'forgotpassword']);
Route::post('forgot-password', [AuthCont::class, 'PostForgotPassword']);
Route::get('reset/{token}', [AuthCont::class, 'reset']);
Route::post('reset/{token}', [AuthCont::class, 'PostReset']);
