                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" value="{{old('date_of_birth', $getRecord->date_of_birth)}}" min="1995-01-02" max="2005-01-02" name="date_of_birth" required>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" value="{{old('admission_date', $getRecord->admission_date)}}" min="2023-01-02" max="2023-10-10" name="admission_date" required>
                    </div>
                    <div class="form-group col-md-6">
